	...
	return (
		<PopoverContent className="bg-background mr-4 flex w-80 flex-col p-0">
			{exportResult && !exportResult.success ? (
				<ExportError
					error={exportResult.error || t.export.unknownError}
				...
				<>
					<div className="flex items-center justify-between p-3 border-b">
						<h3 className="font-medium text-sm">
							{isExporting ? t.export.exportingProject : t.export.exportProject}
						</h3>
					</div>
						...
						{!isExporting && (
							<>
								<div className="flex flex-col">
									...
									>
										<SectionHeader>
											<SectionTitle>{t.export.format}</SectionTitle>
										</SectionHeader>
										<SectionContent>
											<RadioGroup
												value={format}
											...
											>
												<div className="flex items-center space-x-2">
													...
													<Label htmlFor="mp4">{t.export.mp4Compatibility}</Label>
												</div>
												<div className="flex items-center space-x-2">
													<RadioGroupItem value="webm" id="webm" />
													<Label htmlFor="webm">{t.export.webmSmaller}</Label>
												</div>
											</RadioGroup>
										</SectionContent>
									</Section>
									...
									<Section collapsible defaultOpen={false}>
										<SectionHeader>
											<SectionTitle>{t.export.quality}</SectionTitle>
										</SectionHeader>
										<SectionContent>
											<RadioGroup
												value={quality}
											...
											>
												...
												<div className="flex items-center space-x-2">
													...
													<Label htmlFor="medium">{t.export.qualityMedium}</Label>
												</div>
												<div className="flex items-center space-x-2">
												...
												<div className="flex items-center space-x-2">
													...
													<Label htmlFor="very_high">{t.export.qualityVeryHigh}</Label>
												</div>
											</RadioGroup>
										</SectionContent>
									</Section>
									...
									<Section collapsible defaultOpen={false}>
										<SectionHeader>
											<SectionTitle>{t.export.audio}</SectionTitle>
										</SectionHeader>
										<SectionContent>
											<div className="flex items-center space-x-2">
												<Checkbox
												...
												/>
												<Label htmlFor="include-audio">{t.export.includeAudio}</Label>
											</div>
										</SectionContent>
									</Section>
								</div>
